    ...
    <main className="flex min-h-screen flex-col bg-dark" ref={containerRef}>
      ...
      >
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-4">
            ...
            <AnimatedButton variant="outline" className="text-white border-white hover:bg-secondary">
              Watch Demo
            </AnimatedButton>
          </div>
        </div>
      ...
      <section className="bg-dark py-12 md:py-20 text-center px-4 relative overflow-hidden" ref={heroRef}>
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 w-full h-1/2 bg-gradient-to-t from-dark-blue/30 to-transparent" />
        </motion.div>
        ...
        <div className="container mx-auto relative z-10">
          ...
          <FadeIn delay={0.6}>
            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 px-4">
              ...
              <AnimatedButton
                variant="outline"
                className="text-white border-white hover:bg-secondary px-4 sm:px-8 py-2 sm:py-6 text-sm md:text-base mt-3 sm:mt-0"
              >
                Watch Demo Video
              </AnimatedButton>
            </div>
      ...
      <section className="bg-dark-blue py-12 md:py-20 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          ...
          <StaggerChildren className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-8">
            <StaggerItem>
              <AnimatedFeatureCard
                icon="/images/icons/trend-up.png"
      ...
      {/* Stats Section */}
      <section className="bg-dark py-12 md:py-20 px-4" ref={statsRef}>
      ...
      <section className="bg-secondary py-12 md:py-20 px-4 relative overflow-hidden" ref={experienceRef}>
        ...
        <motion.div
          ...
          transition={{ duration: 1 }}
        >
          <div className="absolute top-1/4 right-1/4 w-1/3 h-1/3 bg-primary/5 rounded-full blur-3xl" />
        </motion.div>
      ...
      <section className="bg-cta-blue py-10 md:py-16 px-4 relative overflow-hidden">
        ...
        <motion.div
          ...
          transition={{ duration: 1 }}
        >
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-blue-300/20 to-transparent" />
        </motion.div>
      ...
      {/* Newsletter Section */}
      <section className="bg-gray-100 py-10 md:py-12 px-4">
        <div className="container mx-auto">
      ...
      {/* Footer */}
      <footer className="bg-dark py-10 md:py-12 px-4">
        <div className="container mx-auto">
          <motion.div
          ...
          <StaggerChildren className="flex flex-wrap justify-center gap-4 md:gap-6 mb-6 md:mb-8">
            <StaggerItem>
              <motion.div whileHover={{ y: -2 }} transition={{ duration: 0.2 }}>
